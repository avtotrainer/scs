...
class SchoolDatabase:
    ...
    def create_class_subjects_table(self):
        self.cursor.execute('''CREATE TABLE IF NOT EXISTS class_subjects
                             (class_id INTEGER,
                             subject_id INTEGER,
    ...
    def insert_class_subject(self, class_id, subject_id, hours_per_week):
        self.cursor.execute("INSERT INTO class_subjects (class_id, subject_id, hours_per_week) VALUES (?, ?, ?)",
                            (class_id, subject_id, hours_per_week))
...
# Создание таблицы для связи между классами и предметами
db.create_class_subjects_table()

# Пример добавления связей между классами и предметами
db.insert_class_subject(1, 1, 4)
db.insert_class_subject(1, 2, 3)
db.insert_class_subject(2, 1, 5)
